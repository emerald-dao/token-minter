...
transaction(
    ...
    execute {
      ...
      let squareMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://ipfs.io/ipfs/".concat(squareImage.cid).concat("/").concat(squareImage.path!)),
        mediaType: "image"
      )
      ...
      if let bannerImage = ExampleNFT.getOptionalCollectionAttribute(key: "bannerImage") as! MetadataViews.IPFSFile? {
        bannerMedia = MetadataViews.Media(
            file: MetadataViews.HTTPFile(url: "https://ipfs.io/ipfs/".concat(bannerImage.cid).concat("/").concat(bannerImage.path!)),
            mediaType: "image"
        )
      }
