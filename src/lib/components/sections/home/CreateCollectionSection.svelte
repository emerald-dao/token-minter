<script>
	...
	let steps = [
		...
		},
		{
			...
			description:
				"Take a quick peak through your NFT Collection to make sure everything is aligned and ready for final deployment.",
		},
		{
			title: "Deploy Your Contract",
			description:
				"Deploy your autogenerated smart contract and upload your assets to the contract itself.",
		},
	];
</script>
