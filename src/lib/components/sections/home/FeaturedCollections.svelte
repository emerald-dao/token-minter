<script>
  import { Section, Container, CollectionCard, Stack } from "$atoms";
  ...
  let collections = [
    {
      ...
      owner: "Izzy",
      url: "/TouchstoneBestTeas",
    },
    {
      name: "FLOW FREAKS",
      thumbnailURL: "/flow-freaks-logo.png",
      description: "A Customized Pixelated NFT PFP on Flow.",
      owner: "Cutter",
      url: "/TouchstoneFLOWFREAKS",
    },
  ];
</script>
